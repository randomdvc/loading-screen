...
(function(f, g, k) {
    var l = {
        ...
        wrapItems: function() {
            this.$userItems.wrapAll('<div class=("keepcool-owl-wrapper">').wrap('<div class=("keepcool-owl-item"></div>');
            this.$elem.find(".owl-wrapper").wrap('<div class=("keepcool-owl-wrapper-outer">');
        ...
        buildControls: function() { if (!0 === this.options.navigation || !0 === this.options.pagination) this.owlControls = f('<div class=("keepcool-owl-controls"/>').toggleClass("clickable", !this.browser.isTouch).appendTo(this.$elem);!0 === this.options.pagination && this.buildPagination();!0 === this.options.navigation && this.buildButtons() },
        buildButtons: function() {
            var a = this,
                b = f('<div class=("keepcool-owl-buttons"/>');
        ...
        buildPagination: function() {
            var a = this;
            a.paginationWrapper =
                f('<div class=("keepcool-owl-pagination"/>');
