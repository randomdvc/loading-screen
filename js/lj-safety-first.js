...
(function($) {
    ...
    $(document).ready(function() {
           ...
           $(function() {
             ...
             $('.lj-countdown .row').countdown({
               ...
               render: function(data) {
                 $(this.el).html('<div><div><span>' + (parseInt(this.leadingZeros(data.years, 2)*365) + parseInt(this.leadingZeros(data.days, 2))) + '</span><span>days</span></div><div><span>' + this.leadingZeros(data.hours, 2) + '</span><span>hours</span></div></div><div class=("keepcool-lj-countdown-ms"><div><span>' + this.leadingZeros(data.min, 2) + '</span><span>minutes</span></div><div><span>' + this.leadingZeros(data.sec, 2) + '</span><span>seconds</span></div></div>');
               }
             });
           });*/
        ...
        $.ajaxChimp.translations.lj = {
            'submit': 'Submitting...',
            0: '<i class=("keepcool-fa fa-check"></i> We will be in touch soon!',
            1: '<i class=("keepcool-fa fa-warning"></i> You must enter a valid e-mail address.',
            2: '<i class=("keepcool-fa fa-warning"></i> E-mail address is not valid.',
            3: '<i class=("keepcool-fa fa-warning"></i> E-mail address is not valid.',
            4: '<i class=("keepcool-fa fa-warning"></i> E-mail address is not valid.',
            5: '<i class=("keepcool-fa fa-warning"></i> E-mail address is not valid.'
        }
        ...
        $(function() {
            $("#contactform").submit(function(event) {
                ...
                if (name == "" || email == "" || message == "") {
                    ...
                    input.stop(true).html('<i class=("keepcool-fa fa-warning"></i> All fields are required.');
                    //$("input#contact-email").focus();
                } else if (!isValidEmailAddress(email)) {
                    input.stop(true).html('<i class=("keepcool-fa fa-warning"></i> E-mail address is not valid.');
                    $("input#contact-email").focus();
                } else {
                    $.ajax({
                        type: "POST",
                        ...
                        success: function() {
                            input.html('<i class=("keepcool-fa fa-check"></i> Thank you for your message!');
        ...
        // backstretch
        $("header").backstretch([
            "img/bg-1.png", "img/bg-2.png", "img/bg-3.png"
